...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://jacekostapczuk.github.io";
    ...
    private void deleteTestedTask(String taskName) throws InterruptedException {
        driver.navigate().refresh();
