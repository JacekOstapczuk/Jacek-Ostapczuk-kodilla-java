...
public class InvoiceDaoTestSuite {
    ...
    public void testInvoiceDaoSave() {
        ...
        List<Item>  zbiorpozycji = new ArrayList<>();
        zbiorpozycji.add(koszSliwek);
        zbiorpozycji.add(jedenMotor);
        zbiorpozycji.add(jedenSamochod);
        zbiorpozycji.add(kartonPapieru);
        pojedynczaFaktura.setItems(zbiorpozycji);
